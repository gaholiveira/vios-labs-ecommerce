      ...
      >
        <div className="text-center mb-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
            {/* Visa */}
            <div className="flex items-center justify-center w-14 h-9 bg-white rounded-sm p-2 opacity-90 hover:opacity-100 transition-opacity" title="Visa">
