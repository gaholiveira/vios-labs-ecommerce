...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Tooltip sutil no hover — desktop */}
      <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-sm border border-stone-200/80 bg-white px-3 py-2 text-[10px] font-medium uppercase tracking-[0.2em] text-brand-softblack opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100 md:block">
        Atendimento
      </span>
    </a>
  );
