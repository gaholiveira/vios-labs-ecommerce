...
// Componente para animar seções ao entrar na viewport
...
// Componente para animar os cards de valores
function ValuesGrid() {
  const ref = useRef<HTMLDivElement>(null);
  ...
  const values = [
    {
      ...
      title: "Transparência",
      description: "Acreditamos em comunicação clara e honesta. Você sempre saberá exatamente o que está usando e por quê.",
    },
    {
      icon: (
        <svg
      ...
      title: "Excelência",
      description: "Cada produto passa por rigorosos testes de qualidade e eficácia. Comprometemo-nos apenas com o melhor.",
    },
    {
      icon: (
        <svg
      ...
      description: "Respeitamos o planeta em cada decisão. Nossos processos são pensados para minimizar impacto ambiental.",
    },
  ];
    ...
    >
      {values.map((value, index) => (
        <motion.div key={index} variants={cardVariants} className="text-center">
          <div className="mb-6 text-brand-green">{value.icon}</div>
...
// Componente para animar os fundadores
    ...
    <main className="bg-brand-offwhite">
      ...
      <section className="relative h-[60svh] md:h-[70svh] w-full flex items-center justify-center overflow-hidden bg-brand-softblack">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          />
          <TextReveal
            text="A ciência da melhor versão de si mesmo"
            el="p"
            className="text-brand-offwhite/70 text-sm md:text-base font-light tracking-wide max-w-2xl mx-auto"
            delay={0.5}
            duration={0.6}
          />
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        <AnimatedSection className="text-center mb-16">
          ...
          <TextReveal
            text="Nascemos com um propósito"
            el="h2"
        ...
        <AnimatedSection className="space-y-8 text-brand-softblack/70 text-sm md:text-base font-light leading-relaxed tracking-wide" delay={0.1}>
          <p>
        ...
        <div className="max-w-6xl mx-auto">
          <AnimatedSection className="text-center mb-16">
            ...
            <TextReveal
              text="O que nos move"
              el="h2"
              className="text-brand-softblack text-3xl md:text-4xl font-light uppercase tracking-tighter leading-tight"
              delay={0.2}
              duration={0.6}
            />
          </AnimatedSection>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        {/* Mensagem final */}
        <AnimatedSection className="mt-24 pt-16 border-t border-brand-softblack/10 text-center" delay={0.2}>
      ...
      <section className="bg-brand-softblack py-24 px-6">
        <AnimatedSection className="max-w-3xl mx-auto text-center">
          <TextReveal
            text="Faça Parte da Nossa Jornada"
            el="h2"
            className="text-brand-offwhite text-2xl md:text-3xl font-light uppercase tracking-tighter leading-tight mb-8"
            delay={0.2}
            duration={0.6}
          />
